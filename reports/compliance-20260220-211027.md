...
| **Date** | 2026-02-20T21:10:27Z |
| **Tests** | 22 total: 19 passed, 3 failed, 0 skipped |
| **Grade** | **C** — Moderate issues — 3 test(s) failed |
| **Fedify** | ^1.10.3 |
...
| NodeInfo endpoint | ❌ FAIL | ASSERT FAILED: NodeInfo should report openRegistrations as false |
...
| Featured (pinned) collection | ❌ FAIL | ASSERT FAILED: Featured JSON should have totalItems |
...
| WebFinger alias resolution | ❌ FAIL | ASSERT FAILED: Profile URL should resolve to acct: URI via WebFinger |
...
- **Category:** Discovery
- **Error:** ASSERT FAILED: NodeInfo should report openRegistrations as false

### ❌ Featured (pinned) collection

- **Category:** Collections
- **Error:** ASSERT FAILED: Featured JSON should have totalItems

### ❌ WebFinger alias resolution

- **Category:** Federation
- **Error:** ASSERT FAILED: Profile URL should resolve to acct: URI via WebFinger


---

*Generated by activitypub-tests/run-all.sh — 2026-02-20T21:11:04Z*
